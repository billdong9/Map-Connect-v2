...
export default {
    ...
    yaw: ['Yaw', 0, ''],
    throttle: ['Throttle', 0, ''],
    leftbrake: ['Left Brake', 0, '(The aircraft type must be specified before using it)'],
    rightbrake: ['Right Brake', 0, '(The aircraft type must be specified before using it)'],
    ...
    reversethrust: ['Reverse Thrust', 1, 'Toggle reverse thrust (The aircraft type must be specified before using it)'],
