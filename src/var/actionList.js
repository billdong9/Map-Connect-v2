...
export default {
    ...
    yaw: ['Yaw', 0, ''],
    throttle: ['Throttle', 0, ''],
    leftbrake: ['Left Brake', 0, '(It\'s an unstable action, you MUST check FAQs on the tutorial page before using it!)'],
    rightbrake: ['Right Brake', 0, '(It\'s an unstable action, you MUST check FAQs on the tutorial page before using it!)'],
    ...
    reversethrust: ['Reverse Thrust', 1, 'Toggle reverse thrust (It\'s an unstable action, you MUST check FAQs on the tutorial page before using it!)'],
